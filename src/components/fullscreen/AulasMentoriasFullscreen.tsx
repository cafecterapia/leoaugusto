...
interface AulasMentoriasFullscreenProps {
  isOpen: boolean;
  onClose: () => void;
  imageSrc: string;
  imageAlt: string;
...
export default function AulasMentoriasFullscreen({
  isOpen,
  onClose,
  imageSrc,
  imageAlt,
}: AulasMentoriasFullscreenProps) {
    ...
    >
      ...
      >
        ...
        <div className="text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed space-y-6">
          <p>
            Oferecemos aulas personalizadas e mentorias especializadas em
            Direito Militar, adaptadas às necessidades específicas de cada aluno
            ou profissional.
          </p>

          <p>
            Nossos programas de ensino abrangem desde conceitos fundamentais até
            questões avançadas do direito castrense, proporcionando uma formação
            sólida e prática na área.
          </p>

          <p>
            As mentorias individuais focam no desenvolvimento profissional,
            orientação de carreira e aprofundamento em temas específicos do
            Direito Militar, sempre com abordagem prática e aplicável.
          </p>
        </div>

        <button
          onClick={onClose}
          className="mt-12 px-8 py-3 bg-white text-secondary font-semibold rounded-lg 
